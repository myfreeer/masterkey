...
(function(root) {
    ...
    const masterkey = {
        ...
        makePassword: function(domain, masterKey, passwordLength1) {
            //console.log(this);
            let domainName = this.parseHostName(domain);
            ...
            let bytesKey = this.parseSha(shaKey);
        ...
        makePassword2: function(domain, masterKey, passwordLength1) {
            ...
            let encodedPassword = Base64.encode(String.fromCharCode.apply(null, this.parseSha(this.makePassword(domain, masterKey, 128)))).replace(/[\\\/\+\=]/g, "");
